...
import clasesPrincipales.OrdenarAnimalPorPeso;
...
public class MostrarRefugioPorPeso extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public MostrarRefugioPorPeso() {
		setTitle("Refugio ordenado por peso de animal");
		setResizable(false);
		setModal(true);
	...
	static void rellenarCampos(){
		...
		Collections.sort(arraytmp, new OrdenarAnimalPorPeso());
