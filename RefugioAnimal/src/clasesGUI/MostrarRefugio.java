...
public class MostrarRefugio extends JDialog {
	...
	public static void main(String[] args) {
		try {
			MostrarRefugio dialog = new MostrarRefugio();
	 ...
	 * Create the dialog.
	 */
	public MostrarRefugio() {
		setTitle("Mostrar Refugio Animales");
		setResizable(false);
		setModal(true);
	...
	static void rellenarCampos(){
		tmp = Principal.refugio.refugio.get(i);
		if(tmp != null){
