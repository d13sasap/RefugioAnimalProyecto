...
public class MostrarSinAdoptar extends JDialog {
	 ...
	 */
	public MostrarSinAdoptar() throws ListaVaciaException {
		setTitle("Mostrar Sin adoptar");
		setResizable(false);
		setModal(true);
		i = 0;
	...
	static void rellenarCampos() throws ListaVaciaException{
		...
		tmp = Principal.refugio.getListaNoAdoptados();
		if(tmp.size() != 0){
