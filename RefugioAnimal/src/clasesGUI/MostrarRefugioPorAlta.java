...
import clasesPrincipales.OrdenarAnimalPorAlta;
...
public class MostrarRefugioPorAlta extends JDialog {
	...
	public static void main(String[] args) {
		try {
			MostrarRefugioPorAlta dialog = new MostrarRefugioPorAlta();
	 ...
	 * Create the dialog.
	 */
	public MostrarRefugioPorAlta() {
		setTitle("Refugio ordenado por fecha alta");
		setResizable(false);
		setModal(true);
	...
	static void rellenarCampos(){
		...
		Collections.sort(arraytmp, new OrdenarAnimalPorAlta());
	...
	private static void ordenarArray(){
		Collections.sort(refugio.refugio, new Comparator<Animal>() {
